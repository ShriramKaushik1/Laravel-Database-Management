...
<div class="glass overflow-hidden shadow-xl sm:rounded-2xl p-8 bg-white/80">
    ...
    <form method="POST" action="<?php echo e(route('import.store')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SHRI RAM KAUSHIK\Desktop\PHP ASSIGN\db_manager\resources\views/import/index.blade.php ENDPATH**/ ?>